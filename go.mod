module github.com/systematiccaos/ruuvi-simulator
...
require (
	...
	github.com/systematiccaos/going-forward v1.0.0
...
require (
	...
	github.com/ajstarks/giocanvas v0.0.0-20230704065115-310b7f00ff98 // indirect
